...
SPECIAL_SECTION_ALIASES: dict[str, tuple[tuple[str, str], ...]] = {
    ...
    "STREAMLIT_APP_URL": (
        ...
        ("streamlit", "url"),
        ("streamlit", "base_url"),
        ("telegram", "text_reader_app_url"),
        ("telegram", "streamlit_app_url"),
        ("telegram", "app_url"),
    ),
    "PUBLIC_APP_URL": (("app", "public_url"), ("app", "url"), ("streamlit", "app_url"), ("streamlit", "url")),
    "APP_URL": (("app", "url"), ("app", "base_url"), ("streamlit", "app_url"), ("streamlit", "url")),
    "STREAMLIT_URL": (("streamlit", "url"), ("streamlit", "app_url"), ("app", "url")),
    "TEXT_READER_APP_URL": (("reader", "url"), ("reader", "app_url"), ("text_reader", "url"), ("text_reader", "app_url"), ("telegram", "text_reader_app_url")),
